...
return {
    ...
    user_can_edit_own_warps = false, -- @setting user_can_edit_own_warps if true then the user who made the warp can edit it regardless of the allow_edit_warp setting
